...
import { loadFromEnv, loadSecretFromEnv } from '../../../utils/util';
...
export class GithubUiPlugin implements GitPlugin {
    ...
    async login(page: Page): Promise<void> {
        ...
        await authorizeAppPage.locator(GhLoginPO.githubPasswordField).fill(loadSecretFromEnv('GH_PASSWORD'));
    ...
    private async getGitHub2FAOTP(): Promise<string> {
        const secret = loadSecretFromEnv("GH_SECRET");
