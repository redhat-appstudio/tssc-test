...
export class UiComponent {
  ...
  /**
   * Gets the Developer Hub URL for the component.
   * This URL is used as the entry point for UI automation tests.
   * 
   * @returns The Developer Hub URL string
   */
  public getDeveloperhubUrl(): string {
    return this.component.getDeveloperhubUrl();
  }
