...
/**
 * Error thrown when GitHub Actions workflow operations fail
 */
export class GithubWorkflowError extends GithubError {
  constructor(operation: string, identifier: string, statusCode?: number, cause?: Error) {
    super(`GitHub Actions workflow ${operation} failed: ${identifier}`, statusCode, cause);
