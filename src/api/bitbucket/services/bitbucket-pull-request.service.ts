...
import { BitbucketPullRequest } from '../types/bitbucket.types';
...
export class BitbucketPullRequestService {
  ...
  public async getPullRequests(workspace: string, repoSlug: string): Promise<BitbucketPullRequest[]> {
    const response: any = await this.httpClient.get(`/repositories/${workspace}/${repoSlug}/pullrequests`);
  ...
  public async createPullRequest(
    ...
    return this.httpClient.post(`/repositories/${workspace}/${repoSlug}/pullrequests`, data);
  }
  ...
  public async mergePullRequest(
    ...
    return this.httpClient.post(`/repositories/${workspace}/${repoSlug}/pullrequests/${pullRequestId}/merge`, options);
  }
}
