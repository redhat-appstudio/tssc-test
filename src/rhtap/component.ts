...
import { Git, GitType } from '../rhtap/git/gitInterface';
import { ArgoCD } from './cd/argocd';
import { CI, CIFactory } from './ci';
import { createGit } from './git';
import { BitbucketProvider } from './git/providers/bitbucket';
import { ImageRegistry, createRegistry } from './registry';
...
export class Component {
  ...
  public static async new(
    ...
    try {
      ...
      // Initialize KubeClient inside the try-catch block
